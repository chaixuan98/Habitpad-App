...
public class SensorListener extends Service implements SensorEventListener {
    ...
    private boolean updateIfNecessary() {
        if (steps > lastSaveSteps + SAVE_OFFSET_STEPS ||
            ...
            if (db.getSteps(Util.getToday()) == Integer.MIN_VALUE) {
                ...
                AddStep("1", steps - pauseDifference,Util.getToday());
    ...
    private void AddStep(final String intentUserID, final int step, final long date)
    {
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            Toast.makeText(SensorListener.this,"Insert user step Error!" + e.toString(),Toast.LENGTH_LONG).show();
                        }
        ...
        VolleySingleton.getInstance(SensorListener.this).addToRequestQueue(stringRequest);
