...
public class GamificationActivity extends AppCompatActivity {
    ...
    private String intentUserID, strUserGamificationPoint = "0", strUserGamificationLevel = "0", strUserGamificationRank = "0";

    private int gamificationCardBarValue;
    private ProgressBar gamificationCardPointBar;


    private TextView  gamificationPoint, gamificationLevel, listEmptyTV, gamificationRank;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        gamificationCardPointBar = (ProgressBar) findViewById(R.id.gamification_level_bar);
        gamificationLevel = (TextView) findViewById(R.id.gamification_level);
        listEmptyTV = (TextView) findViewById(R.id.list_empty_tv);
        gamificationRank =(TextView) findViewById(R.id.gamification_ranking);
        rankingLayout = (LinearLayout) findViewById(R.id.ranking_layout);

        DisplayUserTotalPoint(intentUserID);
        DisplayUserRank(intentUserID);
        ...
        rankingLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(GamificationActivity.this,LeaderboardActivity.class));
            }
        });
                        ...
                        try {
                            ...
                            if(success.equals("1")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    gamificationLevel.setText(strUserGamificationLevel);

                                    gamificationCardBarValue = fc.GamificationProgressBarValue(strUserGamificationPoint);
                                    gamificationCardPointBar.setProgress(gamificationCardBarValue);

                                    strUserGamificationLevel = String.valueOf(Integer.parseInt(strUserGamificationPoint)/100);
