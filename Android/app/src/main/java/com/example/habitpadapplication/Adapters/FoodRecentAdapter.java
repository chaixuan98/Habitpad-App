...
public class FoodRecentAdapter extends RecyclerView.Adapter<FoodRecentAdapter.MyViewHolder>{

    private Context mContext;
    private List<FoodRecent> foodRecents = new ArrayList<>();
    private String intentFrom,intentUserGender,intentUserAge,intentUserLifestyle,intentUserWeight,intentUserHeight;



    public FoodRecentAdapter (Context context, List<FoodRecent> foodRecents){
        this.mContext = context;
        this.foodRecents = foodRecents;

    }


    // method for filtering our recyclerview items.
    public void filterList(List<FoodRecent> filterllist) {
        // below line is to add our filtered list in our course array list.
        foodRecents = filterllist;
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder (View view){
            ...
            foodName = view.findViewById(R.id.food_recent_name);
            foodCalories = view.findViewById(R.id.food_recent_calories);
            foodLayout= view.findViewById(R.id.food_recent_layout);
    ...
    @NonNull
    @Override
    public FoodRecentAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mContext).inflate(R.layout.food_recent_raw,parent,false);
        return new FoodRecentAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull FoodRecentAdapter.MyViewHolder holder, int position) {

        final FoodRecent foodRecent = foodRecents.get(position);

        final String foodID = foodRecent.getFoodID();
        String tempFoodName = foodRecent.getFoodname();
        ...
        String tempCalories = foodRecent.getFoodcalories();
